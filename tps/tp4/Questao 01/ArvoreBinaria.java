...
class Arvore {
    ...
    public boolean pesquisar(String elemento) {
        StringBuilder caminho = new StringBuilder(); // Para armazenar o caminho
        boolean encontrado = pesquisar(raiz, elemento, caminho);
        System.out.println(caminho.toString() + (encontrado ? " SIM" : " NÃO"));
        return encontrado;
    }
    ...
    private boolean pesquisar(No no, String elemento, StringBuilder caminho) {
        ...
        if (comparacao == 0) {
            ...
            caminho.append(" esq"); // Caminho para a esquerda
            return pesquisar(no.esq, elemento, caminho);
        } else {
            caminho.append(" dir"); // Caminho para a direita
