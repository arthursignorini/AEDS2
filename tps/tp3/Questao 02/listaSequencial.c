...
// Função para inicializar a lista com um tamanho específico
ArrayList *inicializar(int tam)
{
    ArrayList *lista = (ArrayList *)malloc(sizeof(ArrayList));
    lista->vet = (Pokemon *)malloc(tam * sizeof(Pokemon));
    lista->n = 0;
    lista->tam = tam;
    return lista;
}
...
int inserirInicio(ArrayList *lista, Pokemon x)
{
...
int inserirFim(ArrayList *lista, Pokemon x)
{
    if (lista->n >= lista->tam)
    {
        printf("ERRO: Lista cheia\n");
...
int inserir(ArrayList *lista, Pokemon x, int pos)
{
    if (lista->n >= lista->tam)
    {
        printf("ERRO: Lista cheia\n");
...
Pokemon removerInicio(ArrayList *lista)
{
    if (lista->n == 0)
    {
...
Pokemon removerFim(ArrayList *lista)
{
    if (lista->n == 0)
    {
        printf("ERRO: Lista vazia\n");
    ...
    lista->n--;
    return lista->vet[lista->n];
}

// Função para remover o elemento em uma posição específica
Pokemon remover(ArrayList *lista, int pos)
{
    if (lista->n == 0)
    {
        printf("ERRO: Lista vazia\n");
...
int main(int argc, char **argv)
{
    ArrayList *lista = inicializar(801); 
