...
// Função de ordenação pelo método bolha
void bolha(Pokemon *pokemons[], int tam) {
...
void swap(int i, int j, Pokemon *pokemons[]) {
...
int main(int argc, char **argv) {
  ...
  // Ordena os Pokémon pela geração usando o BubbleSort
  bolha(lista, contador);
